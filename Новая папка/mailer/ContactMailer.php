...
class ContactMailer
{
     ...
     * @var string
     */
    private static $emailFrom = 'Bbs586@yandex.ru';
    /**
     * E-mail получателя
     * @var string
     */
    // private static $emailTo = 'builderpost@ya.ru';
    private static $emailTo = 'bambina-kissi@yandex.ru';
