...
Fancybox.bind("[catalog-gallery]", {
// Your custom options
});
Fancybox.bind("[catalog-gallery-2]", {
// Your custom options
});
Fancybox.bind("[catalog-gallery-2]", {
// Your custom options
});
Fancybox.bind("[catalog-gallery-3]", {
// Your custom options
});
Fancybox.bind("[catalog-gallery-4]", {
// Your custom options
});
Fancybox.bind("[catalog-gallery-5]", {
// Your custom options
});
Fancybox.bind("[catalog-gallery-6]", {
// Your custom options
});
